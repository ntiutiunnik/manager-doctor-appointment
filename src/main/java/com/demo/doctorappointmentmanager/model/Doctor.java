...
public class Doctor implements BasicEntity<Long> {
    ...
    public com.demo.doctorappointmentmanager.model.Department getDepartment() {
        return department;
    }

    public void setDepartment(com.demo.doctorappointmentmanager.model.Department department) {
